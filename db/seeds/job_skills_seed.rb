...
JobSkill.create!(job: PILOTE_DE_LIGNE, skill: PEDAGOGIE)
JobSkill.create!(job: PILOTE_DE_LIGNE, skill: SENS_DU_RELATIONNEL)
...
JobSkill.create!(job: CHIRURGIEN_DENTISTE, skill: HABILITE)
JobSkill.create!(job: CHIRURGIEN_DENTISTE, skill: PRECISION)
JobSkill.create!(job: CHIRURGIEN_DENTISTE, skill: ADAPTATION)
JobSkill.create!(job: CHIRURGIEN_DENTISTE, skill: RESISTANCE_PHYSIQUE)
